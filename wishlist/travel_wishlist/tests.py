...
class TestHomePage(TestCase):
    def test_home_page_shows_empty_list__for_empty_db(self):
...
class TestAddNewPlace(TestCase):
    def test_add_new_unvisited_place_to_wishlist(self):
        ...
        self.assertEqual(1, len(response_places)) # checks just 1
...
class TestVisitPlace(TestCase):
    ...
    def test_non_existent_place(self):
        visit_non_existent_place_url = reverse('place_was_visited', args=(1234567, ))
